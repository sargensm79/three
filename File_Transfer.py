...
control_filename = "AUTOGRAPH_" + str(datetime.date.today() - datetime.timedelta(1)).replace("-", "") + "_000000_001.txt"
...
def encrypt_file(filename):
    ...
    encrypt_file = subprocess.call(["openssl", "enc", "-e",
                                      ...
                                      "-pass",  "file:" + home_path + "Spectrum/ThreeUK/File_Transfer/privkey_AUTOGRAPH_prd.pem"])
